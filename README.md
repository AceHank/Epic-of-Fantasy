...
For modders: If you want to use the assets from this mod, you can contact me in the official Unciv Discord server! I opted to remove them from this repository to reduce mod size!
